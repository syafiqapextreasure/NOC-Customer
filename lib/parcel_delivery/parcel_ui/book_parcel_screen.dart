...
class _BookOrderScreenState extends State<BookParcelScreen> {
  ...
  buildCategory(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color:
              selectedIndex == index ? Color(0xFFFEDF00) : Colors.grey.shade100,
          borderRadius: BorderRadius.circular(8),
        ),
        child: Padding(
          ...
          Row(
            children: [
              Padding(
                ...
                child: Container(
                  decoration: BoxDecoration(
                      shape: BoxShape.circle, color: Color(0xFFFEDF00)),
                  child: const Padding(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                              ...
                              onPressed: () async {
                                ...
                                setState(() {
                                  senderAddress =
                                      "${result.subLocalityLevel1!.name == null ? "" : result.subLocalityLevel1!.name.toString() + ", "}${result.locality!.toString()}";
                                  senderLocation = UserLocation(
  ...
  buildTextFormField(
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
          floatingLabelStyle:
              TextStyle(fontFamily: "GlacialIndifference", color: color),
          ...
          suffixIcon: isIcons
              ...
              : null,
          hintStyle: TextStyle(
              fontFamily: "GlacialIndifference", color: Colors.grey.shade600),
  ...
  buildParcelDropDown({
    ...
    return DropdownButtonFormField<ParcelWeightModel>(
        decoration: InputDecoration(
          //floatingLabelStyle: TextStyle(fontFamily : "GlacialIndifference",color: color),
          labelStyle: TextStyle(
              fontFamily: "GlacialIndifference", color: Colors.grey.shade500),
          floatingLabelBehavior: FloatingLabelBehavior.always,
          labelText: title,
