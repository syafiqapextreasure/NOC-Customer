...
import 'package:nocconsumer/model/RazorPayFailedModel.dart';
...
import 'package:nocconsumer/model/getPaytmTxtToken.dart';
...
class _CartParcelScreenState extends State<CartParcelScreen> {
  ...
  placeParcelOrder() async {
    ...
    parcelOrderModel.adminCommission = commissionAmount.toString();
    parcelOrderModel.adminCommissionType = commissionType.toString();
    ...
    print("parcel ----------->${parcelOrderModel.toJson()}");
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                //showParcelDetails(title: "Rate".tr(), value: "$symbol${subTotal.toStringAsFixed(decimal)}", color: Color(0xFFFEDF00)),
                showParcelDetails(
                    title: "Rate".tr(),
                    value: amountShow(amount: subTotal.toString()),
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            maxLines: 3,
            style: TextStyle(
                fontFamily: "GlacialIndifference", color: Colors.grey.shade500),
          ),
        ],
      ),
    );
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(title,
                style: const TextStyle(
                    fontFamily: "GlacialIndifference", color: Colors.grey)),
            const SizedBox(
              height: 5,
            ),
            Text(value),
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(fontFamily : "GlacialIndifference",color: isDarkMode(context) ? const Color(0xffFFFFFF) : const Color(0xff888888), fontSize: 16),
                      ),
                      Text(
                        //symbol + getTaxAmount().toStringAsFixed(decimal),
                        amountShow(amount: getTaxAmount().toString()),
                        style: TextStyle(fontFamily : "GlacialIndifference",fontWeight: FontWeight.w600, color: isDarkMode(context) ? const Color(0xffFFFFFF) : const Color(0xff333333), fontSize: 16),
                      ),
                    ],
                  ))*/
              // const Padding(
        ...
        return AlertDialog(
          content: Container(
            ...
            child: Text(
              message,
              style:
                  TextStyle(fontFamily: "GlacialIndifference", color: txtColor),
            ),
          ),
        );
      },
            ...
            child: ListBody(
              children: [
                ...
                Text(
                  ...
                  style: const TextStyle(
                      fontFamily: "GlacialIndifference", fontSize: 16),
                ),
                const SizedBox(
                  height: 15,
                ),
