...
import 'package:nocconsumer/parcel_delivery/parcel_ui/book_parcel_screen.dart';
...
class _MyHomePageState extends State<ParcelHomeScreen> {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text("Welcome!!".tr(),
                      style:
                          TextStyle(fontFamily : "GlacialIndifference",color: Color(0xFFFEDF00), fontSize: 19)),
                  Text(
  ...
  buildItems({required ParcelCategory item}) {
    return InkWell(
      splashColor: Color(0xFFFEDF00).withOpacity(0.5),
      onTap: () {
