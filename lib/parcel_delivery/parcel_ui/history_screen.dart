...
import 'package:nocconsumer/parcel_delivery/parcel_ui/parcel_order_track_screen.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      Text("Parcel Type : ".tr(), style: TextStyle(fontFamily : "GlacialIndifference",color: Colors.grey)),
                      const SizedBox(
                        height: 5,
                      ),
                      Text(orderModel.parcelType.toString(), style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 16)),
                    ],
                  ),
                ),
                const SizedBox(
                ...
                Row(
                  ...
                  children: [
                   ...
                   // buildOtherDetails(title: "Rate".tr(), value: symbol + double.parse(orderModel.subTotal!).toStringAsFixed(decimal), color: Color(0xFFFEDF00)),
                    buildOtherDetails(title: "Rate".tr(), value: amountShow(amount: orderModel.subTotal!), color: Color(0xFFFEDF00)),
    ...
    return GestureDetector(
      child: Padding(
        ...
        child: Column(
          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
          children: [
            Text(title, style: const TextStyle(fontFamily : "GlacialIndifference",color: Colors.grey)),
            const SizedBox(
              height: 5,
            ),
            Text(value, textAlign: TextAlign.center, style: TextStyle(fontFamily : "GlacialIndifference",fontSize: 14)),
          ],
        ),
      ),
    );
      ...
      child: Column(
        ...
        children: [
            ...
            child: Row(
              children: [
                Text(
                  ...
                  style: TextStyle(fontFamily : "GlacialIndifference",fontSize: 18, color: isSender ? Color(0xFFFEDF00) : const Color(0xffd17e19)),
                ),
                Text(
          ...
          Text(
            ...
            style: TextStyle(fontFamily : "GlacialIndifference",fontSize: 16, color: Colors.grey.shade500),
          ),
          Text(
