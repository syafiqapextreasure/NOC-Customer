      ...
      body: isLoading
          ...
          : ListView(
              ...
              children: [
                ...
                //     border: Border.all(color: wallet ? Color(0xFFFEDF00) : Colors.black12),
                ...
                //     child: Container(
                //       decoration: BoxDecoration(
                //         border: Border.all(color: flutterWave ? Color(0xFFFEDF00) : Colors.black12),
                //         borderRadius: const BorderRadius.all(Radius.circular(5.0) //                 <--- border radius here
                //             ),
                //       ),
                //       padding: const EdgeInsets.symmetric(horizontal: 10),
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                      "Continue".tr(),
                      style: const TextStyle(fontFamily : "GlacialIndifference",color: Colors.white, fontWeight: FontWeight.bold),
                    ),
                  ),
                ),
              ],
