...
import 'package:nocconsumer/cab_service/intercity_payment_selection_screen.dart';
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        border: selectedTripOption == "One-way"
                            ? Border.all(color: Color(0xFFFEDF00))
                            : null,
                        borderRadius: const BorderRadius.only(
                ...
                Expanded(
                  child: InkWell(
                    onTap: () async {
                      ...
                      //       .now(), // Use DateTime.now() or another appropriate initial date
                      ...
                      decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder(
                            ...
                            borderSide: BorderSide(
                                color: Color(0xFFFEDF00), width: 2.0)),
                      ),
                    ),
                  ),
                ),
