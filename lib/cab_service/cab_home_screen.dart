...
import 'package:nocconsumer/cab_service/cab_intercity_service_screen.dart';
import 'package:nocconsumer/cab_service/cab_service_screen.dart';
            ...
            children: [
              ...
              Expanded(
                child: Padding(
                  ...
                  child: Text("WelCome".tr() +" ${MyAppState.currentUser == null ? '' : MyAppState.currentUser!.firstName ?? ''}", style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 22, color: Colors.black)).tr(),
                ),
              ),
            ],
          ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(
                     ...
                     Text(
                      "Choose Your Ride".tr(),
                      style:const TextStyle(fontFamily : "GlacialIndifference",color: Colors.black, fontSize: 18, fontWeight: FontWeight.w500),
                    ),
                    Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      const SizedBox(
                                       ...
                                       Text(
                                        "Ride".tr(),
                                        style: TextStyle(fontFamily : "GlacialIndifference",fontSize: 18, fontWeight: FontWeight.w500),
                                      ),
                                      const SizedBox(
                                        height: 20,
                                      ),
