            ...
            if (razorPay) {
              ...
              FireStoreUtils.createPaymentId().then((value) {
                ...
                FireStoreUtils.topUpWalletAmount(
                        ...
                        paymentMethod: "Wallet".tr(),
                        isTopup: false,
                        orderId: widget.cabOrderModel!.id,
                        amount: getTotalAmount(),
                        id: paymentID)
                    .then((value) {
  ...
  Widget paymentListView() {
    return Column(
      children: [
        ...
        //                   ? Container(
        //                       decoration: BoxDecoration(
        //                         border: Border.all(color: codPay ? Color(0xFFFEDF00) : Colors.black12),
        ...
        //     child: Container(
        //       decoration: BoxDecoration(
        //         border: Border.all(color: razorPay ? Color(0xFFFEDF00) : Colors.black12),
        //         borderRadius: const BorderRadius.all(Radius.circular(5.0) //                 <--- border radius here
        //         ),
        //       ),
        //       padding: const EdgeInsets.symmetric(horizontal: 10),
        ...
        //     child: Container(
        //       decoration: BoxDecoration(
        //         border: Border.all(color: stripe ? Color(0xFFFEDF00) : Colors.black12),
        //         borderRadius: const BorderRadius.all(Radius.circular(5.0) //                 <--- border radius here
        //         ),
        //       ),
        //       padding: const EdgeInsets.symmetric(horizontal: 10),
        ...
        //     child: Container(
        //       decoration: BoxDecoration(
        //         border: Border.all(color: payTm ? Color(0xFFFEDF00) : Colors.black12),
        //         borderRadius: const BorderRadius.all(Radius.circular(5.0) //                 <--- border radius here
        //         ),
        //       ),
        //       padding: const EdgeInsets.symmetric(horizontal: 10),
        ...
        //     child: Container(
        //       decoration: BoxDecoration(
        //         border: Border.all(color: paypal ? Color(0xFFFEDF00) : Colors.black12),
        //         borderRadius: const BorderRadius.all(Radius.circular(5.0) //                 <--- border radius here
        //         ),
        //       ),
        //       padding: const EdgeInsets.symmetric(horizontal: 10),
        ...
        //     child: Container(
        //       decoration: BoxDecoration(
        //         border: Border.all(color: payFast ? Color(0xFFFEDF00) : Colors.black12),
        //         borderRadius: const BorderRadius.all(Radius.circular(5.0) //                 <--- border radius here
        //         ),
        //       ),
        //       padding: const EdgeInsets.symmetric(horizontal: 10),
        ...
        //     child: Container(
        //       decoration: BoxDecoration(
        //         border: Border.all(color: payStack ? Color(0xFFFEDF00) : Colors.black12),
        //         borderRadius: const BorderRadius.all(Radius.circular(5.0) //                 <--- border radius here
        //         ),
        //       ),
        //       padding: const EdgeInsets.symmetric(horizontal: 10),
    ...
    await PayStackURLGen.payStackURLGen(
      ...
      if (value != null) {
        if (value["status"]) {
          ...
          Navigator.pop(_globalKey.currentContext!);
          showAlert(_globalKey.currentContext!,
              response: value['message'].toString(), colors: Colors.red);
        }
      } else {
        Navigator.pop(_globalKey.currentContext!);
        showAlert(_globalKey.currentContext!,
