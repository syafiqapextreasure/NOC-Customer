            ...
            child: Column(
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Text(
                      'publicInfo'.tr(),
                      style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 16, color: Colors.grey),
                    ).tr(),
                  ),
                  Material(
                      elevation: 2,
                  ...
                  Padding(
                    ...
                    child: Text(
                      'privateDetails'.tr(),
                      style: TextStyle(fontFamily : "GlacialIndifference",fontSize: 16, color: Colors.grey),
                    ).tr(),
                  ),
                  Material(
                    elevation: 2,
