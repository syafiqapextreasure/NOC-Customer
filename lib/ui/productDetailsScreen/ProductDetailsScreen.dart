...
import 'package:nocconsumer/ecommarce_service/ecommarce_dashboard.dart';
import 'package:nocconsumer/ecommarce_service/view_all_brand_product_screen.dart';
import 'package:nocconsumer/main.dart';
import 'package:nocconsumer/model/AttributesModel.dart';
import 'package:nocconsumer/model/BrandsModel.dart';
import 'package:nocconsumer/model/FavouriteItemModel.dart';
import 'package:nocconsumer/model/ItemAttributes.dart';
import 'package:nocconsumer/model/ProductModel.dart';
import 'package:nocconsumer/model/Ratingmodel.dart';
import 'package:nocconsumer/model/ReviewAttributeModel.dart';
import 'package:nocconsumer/model/VendorModel.dart';
import 'package:nocconsumer/model/variant_info.dart';
import 'package:nocconsumer/services/FirebaseHelper.dart';
import 'package:nocconsumer/services/Indicator.dart';
...
import 'package:nocconsumer/ui/cartScreen/CartScreen.dart';
import 'package:nocconsumer/ui/container/ContainerScreen.dart';
import 'package:nocconsumer/ui/vendorProductsScreen/review.dart';
...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
                        ...
                        Row(
                          children: [
                            ...
                            widget.productModel.disPrice == "" || widget.productModel.disPrice == "0"
                              ...
                              style: TextStyle(fontFamily : "GlacialIndifference",letterSpacing: 0.5, color: Color(0xFFFEDF00)),
                                  )
                                : Row(
                                    children: [
                                      Text(
                                      ...
                                      Text(
                                        "${amountShow(amount: widget.productModel.price)}",
                                        style: const TextStyle(fontFamily : "GlacialIndifference",fontWeight: FontWeight.bold, color: Colors.grey, decoration: TextDecoration.lineThrough),
                                      ),
                                    ],
                                  ),
                          ],
                            ...
                            sectionConstantModel!.serviceTypeFlag == "ecommerce-service"
                                ? productQnt == 0
                                    ? TextButton.icon(
                                        onPressed: () {
                                          if (MyAppState.currentUser == null) {
                                            ...
                                            setState(() {
                                              ...
                                              if (variants!.where((element) => element.variant_sku == selectedVariants.join('-')).isNotEmpty) {
                                                if (int.parse(variants!.where((element) => element.variant_sku == selectedVariants.join('-')).first.variant_quantity.toString()) >= 1 ||
                                                    int.parse(variants!.where((element) => element.variant_sku == selectedVariants.join('-')).first.variant_quantity.toString()) == -1) {
                                        ...
                                        label: Text(
                                          'ADD'.tr(),
                                          style: TextStyle(fontFamily : "GlacialIndifference",color: isDarkMode(context) ? Color(0xFFFEDF00) : Colors.black),
                                        ),
                                    ...
                                    : Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            productQnt.toString(),
                                            style: TextStyle(fontFamily : "GlacialIndifference",fontSize: 16, color: Color(0xFFFEDF00)),
                                          ),
                                          const SizedBox(
                                            width: 5,
                                          ),
                                          IconButton(
                                              onPressed: () {
                                                setState(() {
                                                  if (variants!.where((element) => element.variant_sku == selectedVariants.join('-')).isNotEmpty) {
                                                    if (int.parse(variants!.where((element) => element.variant_sku == selectedVariants.join('-')).first.variant_quantity.toString()) > productQnt ||
                                                        int.parse(variants!.where((element) => element.variant_sku == selectedVariants.join('-')).first.variant_quantity.toString()) == -1) {
                                                      VariantInfo? variantInfo = VariantInfo();
                                                      Map<String, String> mapData = Map();
                                                      for (var element in attributes!) {
                              ...
                              child: Row(
                                children: [
                                  ...
                                  InkWell(
                                      ...
                                      child: Text(widget.vendorModel.title, style: TextStyle(fontFamily : "GlacialIndifference",color: Color(0xFFFEDF00)))),
                                ],
                              ),
                            ),
                            brandModel == null
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        InkWell(
                                            ...
                                            child: Text(brandModel != null ? brandModel!.title.toString() : "", style: TextStyle(fontFamily : "GlacialIndifference",color: Color(0xFFFEDF00)))),
                                      ],
                                    ),
                                  ),
                          ],
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          "Details".tr(),
                          style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 16, fontWeight: FontWeight.w500),
                        ),
                        const SizedBox(
                          height: 5,
                        ),
                                  ...
                                  Column(
                                    children: [
                                      Text(
                                        ...
                                        style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 20),
                                      ),
                                      const SizedBox(
                                        height: 8,
                                      ),
                                      Text("kcal".tr(), style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 16))
                                    ],
                                  ),
                                  Column(
                                    children: [
                                      Text(widget.productModel.grams.toString(), style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 20)),
                                      const SizedBox(
                                        height: 8,
                                      ),
                                      Text("grams".tr(), style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 16))
                                    ],
                                  ),
                                  Column(
                                    children: [
                                      Text(widget.productModel.proteins.toString(), style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 20)),
                                      const SizedBox(
                                        height: 8,
                                      ),
                                      Text("proteins".tr(), style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 16))
                                    ],
                                  ),
                                  Column(
                                    children: [
                                      Text(widget.productModel.fats.toString(), style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 20)),
                                      const SizedBox(
                                        height: 8,
                                      ),
                                      Text("fats".tr(), style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 16))
                                    ],
                                  )
                                ],
                              ))),
                                ...
                                return Column(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Text(
                                        title,
                                        style: const TextStyle(fontFamily : "GlacialIndifference",color: Colors.black, fontSize: 16, fontWeight: FontWeight.w500),
                                      ),
                                    ),
                                    Padding(
                      ...
                      : Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                "Addons".tr(),
                                style: TextStyle(fontFamily : "GlacialIndifference",  fontSize: 16, color: isDarkMode(context) ? const Color(0xffffffff) : const Color(0xff000000)),
                              ),
                            ),
                            Padding(
                              padding: const EdgeInsets.symmetric(horizontal: 15),
                                      ...
                                      child: Row(
                                        children: [
                                          Text(
                                            ...
                                            style: TextStyle(fontFamily : "GlacialIndifference",color: isDarkMode(context) ? const Color(0xffC6C4C4) : const Color(0xff5E5C5C)),
                                          ),
                                          const Expanded(child: SizedBox()),
                                          Text(
                                            amountShow(amount: lstAddAddonsCustom[index].price!),
                                            style: TextStyle(fontFamily : "GlacialIndifference",fontWeight: FontWeight.bold, color: Color(0xFFFEDF00)),
                                          ),
                                          GestureDetector(
                                            onTap: () {
                                              setState(() {
                            ...
                            child: Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    "Specification".tr(),
                                    style: TextStyle(fontFamily : "GlacialIndifference",  fontSize: 20, color: isDarkMode(context) ? const Color(0xffffffff) : const Color(0xff000000)),
                                  ),
                                ),
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(widget.productModel.specification.keys.elementAt(index) + " : ",
                                              style: TextStyle(fontFamily : "GlacialIndifference",color: Colors.black.withOpacity(0.60), fontWeight: FontWeight.w500, letterSpacing: 0.5, fontSize: 14)),
                                          Text(widget.productModel.specification.values.elementAt(index),
                                              style: TextStyle(fontFamily : "GlacialIndifference",color: Colors.black.withOpacity(0.90), fontWeight: FontWeight.w500, letterSpacing: 0.5, fontSize: 14)),
                                        ],
                                      ),
                                    );
                                  },
                              ...
                              child: Row(
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    child: Text(
                                      "See All".tr(),
                                      style: TextStyle(fontFamily : "GlacialIndifference",fontSize: 16, color: isDarkMode(context) ? const Color(0xffffffff) : Color(0xFFFEDF00)),
                                    ),
                                  ),
                                ],
                              ),
                                                          ...
                                                          style: TextStyle(fontFamily : "GlacialIndifference",letterSpacing: 0.5, color: Color(0xFFFEDF00)),
                                                            ...
                                                            : Column(
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                    '${amountShow(amount: productModel.price)}',
                                                                    style: const TextStyle(fontFamily : "GlacialIndifference",fontWeight: FontWeight.bold, fontSize: 12, color: Colors.grey, decoration: TextDecoration.lineThrough),
                                                                  ),
                                                                ],
                                                              ),
                                                      ],
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            ...
                                            style: const TextStyle(fontFamily : "GlacialIndifference",color: Colors.black, fontWeight: FontWeight.w400),
                                          )
                                        ],
                                      ),
                                    );
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Text(
                                                    ...
                                                    style: const TextStyle(fontFamily : "GlacialIndifference",color: Colors.black, fontWeight: FontWeight.w600, letterSpacing: 1, fontSize: 16),
                                                  ),
                                                  RatingBar.builder(
                                                    ignoreGestures: true,
                                            ...
                                            Text(orderDate(reviewList[index].createdAt), style: TextStyle(fontFamily : "GlacialIndifference",color: isDarkMode(context) ? Colors.grey.shade200 : const Color(0XFF555353))),
                                          ],
                                        ),
                                        // const Padding(
                                        ...
                                        Text(reviewList[index].comment.toString(),
                                            style: TextStyle(fontFamily : "GlacialIndifference",color: Colors.black.withOpacity(0.70), fontWeight: FontWeight.w400, letterSpacing: 1, fontSize: 14)),
                                        const SizedBox(
                                          height: 10,
                                        ),
                          ...
                          child: Padding(
                            ...
                            child: SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                child: const Text(
                                  'See All Reviews',
                                  style: TextStyle(fontFamily : "GlacialIndifference",fontWeight: FontWeight.w600, fontSize: 16, color: Colors.white),
                                ).tr(),
                                onPressed: () {
                                  push(
                                    context,
                ...
                children: [
                  Expanded(
                    child: Text(
                      ...
                      style: const TextStyle(fontFamily : "GlacialIndifference",color: Colors.black, fontSize: 18),
                    ).tr(),
                  ),
                  GestureDetector(
                    onTap: () {
  ...
  Widget _buildChip(String label, int attributesOptionIndex, bool isSelected) {
    return Chip(
      ...
      backgroundColor: isSelected ? Color(0xFFFEDF00) : Colors.white,
      elevation: 6.0,
    ...
    //     child: Container(
    //       decoration: BoxDecoration(
    //         color: isSelected ? Color(0xFFFEDF00) : Colors.white,
