                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Icon(Icons.subdirectory_arrow_left,
                                        color: Color(0xFFFEDF00), size: 22),
                                  ),
                                ),
                              ),
                            ),
  ...
  buildDetails(
    ...
    return ListTile(
      ...
      subtitle: Text(
        value,
        style:
            TextStyle(fontFamily : "GlacialIndifference",color: isDarkMode(context) ? Colors.white : Colors.black),
      ),
    );
  }
              ...
              if (orderModel.status == ORDER_STATUS_ACCEPTED) {
                ...
                Polyline polyline = Polyline(
                  polylineId: PolylineId(
                      'polyline_id_${orderModel.author.firstName}_to_${orderModel.vendor.title}'),
                  color: isDarkMode(context) ? Colors.white : Colors.black,
                  width: 5,
