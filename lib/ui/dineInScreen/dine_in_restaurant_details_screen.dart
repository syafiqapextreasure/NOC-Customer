...
import 'package:nocconsumer/ui/vendorProductsScreen/photos.dart';
...
class _DineInRestaurantDetailsScreenState
  ...
  void _getUserLocation() async {
    setState(() {
      position = LatLng(MyAppState.selectedPosition.latitude,
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    widget.vendorModel.restaurantMenuPhotos
                                            .isEmpty
                                        ? Container()
                                        : GestureDetector(
                                            onTap: () {
                              ...
                              widget.vendorModel.restaurantMenuPhotos.isEmpty
                                  ? showEmptyState(
                                      'No Menu Photos'.tr(),
                                      context,
                                    )
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                                  ...
                                                  // widget.vendorModel.restaurantCost == 0 ? "Approx cost is not added".tr() : "Cost for two".tr() + "$symbol${widget.vendorModel.restaurantCost} (Approx)",
                                                  style: const TextStyle(fontFamily : "GlacialIndifference",))
                                              .tr()
                                        ],
                                      ),
    ...
    if (widget.vendorModel.reststatus == true) {
      return Container(
          ...
          child: Row(children: [
            ...
            Text("Open".tr(),
                style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 16, color: Color(0XFF3dae7d)))
          ]));
    } else {
      return Container(
          height: 35,
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text("valid till ".tr() + "Nov 31,2022",
                          style: TextStyle(fontFamily : "GlacialIndifference",letterSpacing: 0.5))
                    ],
                  ),
                ],
              )),
                      ...
                      Padding(
                        ...
                        child: MaterialButton(
                          ...
                          onPressed: () async {
                            ...
                            await FireStoreUtils.sendFcmMessage(dineInPlaced,
