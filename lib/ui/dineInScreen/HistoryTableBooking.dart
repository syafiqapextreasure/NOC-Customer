...
import 'package:nocconsumer/ui/dineInScreen/table_order_details_screen.dart';
                        ...
                        children: [
                          ...
                          ListTile(
                            ...
                            subtitle: Text(
                              ...
                              style: const TextStyle(fontFamily : "GlacialIndifference",color: Colors.grey),
                            ),
                          ),
                          ListTile(
                            title: Text(
                          ...
                          ListTile(
                            ...
                            minLeadingWidth: 10,
                            subtitle: Text('${bookTableModel.totalGuest}', style: const TextStyle(fontFamily : "GlacialIndifference",color: Colors.grey)),
                          ),
                          Padding(
                            ...
                            child: Center(
                                child: Text(
                              bookStatus,
                              style: const TextStyle(fontFamily : "GlacialIndifference",letterSpacing: 0.5, color: Colors.green, fontSize: 16, fontWeight: FontWeight.bold),
                            )),
                          )
                        ],
                      ),
