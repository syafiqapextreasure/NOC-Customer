        ...
        child: Padding(
          ...
          child: GestureDetector(
              ...
              child: Column(children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: NetworkImage(
                              (orderModel.products.first.photo != null &&
                                      orderModel
                                          .products.first.photo.isNotEmpty)
                ...
                //       decoration: BoxDecoration(borderRadius: BorderRadius.circular(5), border: Border.all(width: 0.8, color: Color(0xFFFEDF00))),
                //       child: Center(
                //         child: Text(
                //           'REORDER'.tr(),
                //           style: TextStyle(fontFamily : "GlacialIndifference",color: isDarkMode(context) ? const Color(0xffFFFFFF) : Colors.black,  fontSize: 15),
                //         ),
                //       )),
                //   onTap: () {
