                      ...
                      Container(
                        ...
                        child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              labelStyle: const TextStyle(fontFamily : "GlacialIndifference",color: Color(0Xff696A75), fontSize: 17),
                              hintStyle: TextStyle(fontFamily : "GlacialIndifference",color: Colors.grey.shade400),
                              focusedBorder: UnderlineInputBorder(
                                borderSide: BorderSide(color: Color(0xFFFEDF00)),
                              ),
      ...
      bottomNavigationBar: Container(
        child: Padding(
          ...
          child: ElevatedButton(
            ...
            child: Text(
              'DONE'.tr(),
              style: TextStyle(fontFamily : "GlacialIndifference",color: isDarkMode(context) ? Colors.white : Colors.black, fontWeight: FontWeight.bold, fontSize: 18),
            ),
          ),
        ),
      ),
