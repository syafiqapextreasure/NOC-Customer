...
import 'package:nocconsumer/ui/home/view_all_offer_screen.dart';
import 'package:nocconsumer/ui/home/view_all_popular_food_near_by_screen.dart';
import 'package:nocconsumer/ui/home/view_all_popular_store_screen.dart';
import 'package:nocconsumer/ui/home/view_all_restaurant.dart';
          ...
          children: [
            CachedNetworkImage(
              ...
              imageBuilder: (context, imageProvider) => Container(
                ...
                decoration: BoxDecoration(
                    border: Border.all(width: 6, color: Color(0xFFFEDF00)),
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                      "${kilometer.toDouble().toStringAsFixed(currencyData!.decimal)}" "KM".tr(),
                                      style:
                                          const TextStyle(fontFamily : "GlacialIndifference",color: Colors.white)),
                                  const SizedBox(
                                    width: 5,
                                  ),
                                  Container(
