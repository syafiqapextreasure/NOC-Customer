          ...
          Stack(
            ...
            children: [
              ...
              Positioned(
                  ...
                  child: Text(
                    "OFFERS\nFOR YOU".tr(),
                    style: const TextStyle(fontFamily : "GlacialIndifference",color: Colors.white, fontSize: 28, fontWeight: FontWeight.bold),
                  )),
              Positioned(
                left: 10,
                top: 10,
                                  ...
                                  child: Padding(
                                    ...
                                    child: Container(
                                        ...
                                        child: Text(
                                          ...
                                          maxLines: 1,
                                          overflow: TextOverflow.ellipsis,
                                          style: TextStyle(fontFamily : "GlacialIndifference",fontSize: 15, fontWeight: FontWeight.bold, letterSpacing: 0.5, color: Color(0xFFFEDF00)),
                                        )),
                                  ),
                                ),
                              ),
              ...
              children: [
                ...
                Container(
                  ...
                  //  "${offerModel.discountTypeOffer == "Fix Price".tr() ? currencyData!.symbol : ""}${offerModel.discountOffer}${offerModel.discountTypeOffer == "Percentage" ? "% Off" : " Off"}",
                    offerModel.discountTypeOffer == "Fix Price" ? (currencyData!.symbolatright == true) ? "${offerModel.discountOffer}${currencyData!.symbol.toString()} OFF":"${currencyData!.symbol.toString()}${offerModel.discountOffer} OFF"
                        : "${offerModel.discountOffer} % Off",
                    style: const TextStyle(fontFamily : "GlacialIndifference",color: Colors.white, fontWeight: FontWeight.bold, letterSpacing: 0.7),
                  ),
                )
              ],
            ),
