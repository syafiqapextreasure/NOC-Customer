              ...
              child: Positioned(
                  ...
                  child: Container(
                      ...
                      child: ElevatedButton(
                        style: ElevatedButton.styleFrom(shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(6)), backgroundColor: Color(0xFFFEDF00)),
                        child: Text(
                          "GET STARTED".tr(),
                          style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 16, color: Colors.black),
                        ),
                        onPressed: () {
          ...
          Center(
            ...
            child: Align(
              ...
              child: SmoothPageIndicator(
                ...
                effect: ScrollingDotsEffect(spacing: 20, activeDotColor: Color(0xFFFEDF00), dotColor: const Color(0XFFFBDBD1), dotWidth: 7, dotHeight: 7, fixedCenter: false),
              ),
            ),
          )),
          Visibility(
          ...
          Visibility(
              ...
              child: Positioned(
                  ...
                  child: InkWell(
                      ...
                      child: Text(
                        "SKIP".tr(),
                        style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 19, color: Color(0XFFFF683A)),
                      )))),
          Visibility(
              visible: _currentIndex + 1 != _imageList.length,
              child: Positioned(
                  ...
                  child: InkWell(
                      ...
                      child: Container(
                          ...
                          child: ElevatedButton(
                            ...
                            child: Text(
                              "NEXT".tr(),
                              style: TextStyle(fontFamily : "GlacialIndifference",fontSize: 16, color: isDarkMode(context) ? const Color(0xffFFFFFF) : const Color(0XFF333333)),
                            ),
                            onPressed: () {
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Text(
          ...
          style: TextStyle(fontFamily : "GlacialIndifference",color: isDarkMode(context) ? const Color(0xffFFFFFF) : const Color(0XFF333333), fontSize: 20),
        ),
        ...
        Padding(
            ...
            child: Text(
              _subtitlesList,
              textAlign: TextAlign.center,
              style: TextStyle(fontFamily : "GlacialIndifference",color: isDarkMode(context) ? const Color(0xffFFFFFF) : const Color(0XFF333333), height: 2, letterSpacing: 1.2, fontSize: 15),
            )),
        ...
        //   child: Text(
        //     subTitle,
        //     style: TextStyle(fontFamily : "GlacialIndifference",color: Colors.white, fontSize: 14.0),
        //     textAlign: TextAlign.center,
        //   ),
        // ),
      ],
