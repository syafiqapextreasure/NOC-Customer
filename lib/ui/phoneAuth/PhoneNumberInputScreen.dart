              ...
              children: <Widget>[
                Align(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(fontFamily : "GlacialIndifference", color: isDarkMode(context) ? Colors.white : Colors.black, fontWeight: FontWeight.bold, fontSize: 25.0),
                    ).tr()),
                  ...
                  child: Padding(
                    ...
                    child: PinCodeTextField(
                      ...
                      pinTheme: PinTheme(
                          ...
                          selectedColor: Color(0xFFFEDF00),
                  ...
                  child: Padding(
                    ...
                    child: ConstrainedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: Text(
                          'sendCode'.tr(),
                          style: TextStyle(fontFamily : "GlacialIndifference",fontSize: 20, fontWeight: FontWeight.bold, color: isDarkMode(context) ? Colors.black : Colors.white),
                        ),
                      ),
                    ),
                  ),
