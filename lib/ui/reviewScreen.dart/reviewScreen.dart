...
import 'package:nocconsumer/ui/fullScreenImageViewer/fullscreenimage.dart';
import 'package:nocconsumer/ui/ordersScreen/OrdersScreen.dart';
                            ...
                            Card(
                                ...
                                child: SizedBox(
                                    ...
                                    child: Column(children: [
                                      ...
                                      Container(
                                          alignment: Alignment.center,
                                          child: Text(widget.product.name, style: TextStyle(fontFamily : "GlacialIndifference",color: isDarkMode(context) ? const Color(0XFFFDFEFE) : const Color(0XFF000003), fontSize: 20))),
                                      const SizedBox(
                                        height: 15,
                                      ),
                                      RatingBar.builder(
                              ...
                              child: Card(
                                  ...
                                  child: SizedBox(
                                      ...
                                      child: Column(children: [
                                        ...
                                        Text("Add Images".tr(), style: const TextStyle(fontFamily : "GlacialIndifference",color: Color(0XFF666666), fontSize: 16))
                                      ]))),
                            ),
                            _mediaFiles.isEmpty
                                ? Container()
                                      ...
                                      child: SingleChildScrollView(
                                        child: Container(
                                            ...
                                            child: TextFormField(
                                              ...
                                              decoration: InputDecoration(hintText: 'Type comment....'.tr(), hintStyle: const TextStyle(fontFamily : "GlacialIndifference",color: Color(0XFF8A8989)), border: InputBorder.none),
                                              maxLines: null,
                                            )),
                                      ),
                                    ))),
        ...
        bottomNavigationBar: ratingModel != null
            ? Padding(
                ...
                child: ElevatedButton(
                  ...
                  child: Text(
                    'UPDATE REVIEW'.tr(),
                    style: TextStyle(fontFamily : "GlacialIndifference",color: Colors.black, fontSize: 17),
                  ),
                ),
              )
            : Padding(
                ...
                child: ElevatedButton(
                  ...
                  child: Text(
                    'SUBMIT REVIEW'.tr(),
                    style: TextStyle(fontFamily : "GlacialIndifference",color: isDarkMode(context) ? Colors.white : Colors.black, fontSize: 17),
                  ),
                ),
              )
        //
