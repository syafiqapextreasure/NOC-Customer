...
class _MapViewScreenState extends State<MapViewScreen> {
  ...
  getDirections(double latitude, double longLatitude) async {
    ...
    PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
      GOOGLE_API_KEY,
      PointLatLng(MyAppState.selectedPosition.latitude, MyAppState.selectedPosition.longitude),
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                  vendors[index].title,
                                                  style: TextStyle(fontFamily : "GlacialIndifference",fontWeight: FontWeight.bold, color: isDarkMode(context) ? Colors.white70 : Colors.black, fontSize: 17),
                                                ),
                                                Row(
                                                  children: [
                                                    Icon(Icons.star, color: Color(0xFFFEDF00)),
