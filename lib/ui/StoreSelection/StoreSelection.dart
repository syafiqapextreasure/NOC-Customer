...
import 'package:nocconsumer/parcel_delivery/parcel_dashboard.dart';
...
import 'package:nocconsumer/ui/QrCodeScanner/QrCodeScanner.dart';
...
class StoreSelectionState extends State<StoreSelection> {
  ...
  setCurrency() async {
    ...
    // await getCountry();
    MyAppState.selectedPosition = await getCurrentLocation();
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        //     style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 18, fontWeight: FontWeight.normal),
        //   ),
        //   actions: [
          ...
          children: [
            ...
            GestureDetector(
                ...
                child: Banner_Url.isEmpty
                    ...
                    //                 ),
                    //         ],
                    //         image: DecorationImage(image: NetworkImage(Banner_Url), fit: BoxFit.cover, colorFilter: ColorFilter.mode(Colors.black.withOpacity(0.5), BlendMode.screen))),
                    //   ),
                    : Container(
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                onPressed: (){
                Navigator.push(context, MaterialPageRoute(builder: (ctx)=> CustomerSupport()));
              },
                  child: Text(
                    'Help Center',
                    style: TextStyle(
            ...
            Container(
              ...
              child: IconButton(
                        ...
                        icon: Stack(
                          ...
                          children: const [
                            Image(
                              image: AssetImage("assets/images/scan-icon 1.png"),
                              width: 100,
                              // color: Colors.black,
                            ),
                          ],
    ...
    return Padding(
        ...
        child: GestureDetector(
          onTap: () async {
            ...
            //       0xFFFEDF00 = int.parse(sectionModel.color!.replaceFirst("#", "0xff"));
