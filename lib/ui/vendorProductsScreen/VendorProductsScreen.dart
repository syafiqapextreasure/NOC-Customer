...
//                               maxLines: 2,
//                               style: const TextStyle(fontFamily : "GlacialIndifference", letterSpacing: 0.5, color: Color(0xFF9091A4)),
//                             ))
//                       ])),
//                   InkWell(
//                       onTap: () {
...
//                                 style: const TextStyle(fontFamily : "GlacialIndifference", letterSpacing: 0.5, color: Color(0xff565764)),
//                               ).tr()
//                             ]),
//                             Column(children: [
//                               Image(
...
//                                   const Text(
//                                     "Share",
//                                     style: TextStyle(fontFamily : "GlacialIndifference", letterSpacing: 0.5, color: Color(0xff565764)),
//                                   ).tr()
//                                 ])),
//                           ],
//                         ))),
...
//                               setState(() {});
//                             },
//                             activeBackgroundColor: Color(0xFFFEDF00),
//                             label: Text(
...
//                 //           labelStyle: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 16),
//                 //           unselectedLabelStyle: const TextStyle(fontFamily : "GlacialIndifference",),
...
//           //             style: const TextStyle(fontFamily : "GlacialIndifference", color: Colors.white, fontSize: 16),
//           //           ).tr(),
//           //           const SizedBox(
//           //             width: 15,
//           //           ),
//           //           const Text("|", style: TextStyle(fontFamily : "GlacialIndifference",color: Colors.white, fontSize: 16)),
//           //           const SizedBox(
//           //             width: 15,
//           //           ),
//           //           Text(
...
//           //           const Text(
//           //             "VIEW CART",
//           //             style: TextStyle(fontFamily : "GlacialIndifference", color: Colors.white, fontSize: 16),
//           //           ).tr(),
//           //           const SizedBox(
//           //             width: 10,
//           //           ),
...
//                           style: const TextStyle(fontFamily : "GlacialIndifference",color: Color(GREY_TEXT_COLOR), fontWeight: FontWeight.bold, letterSpacing: 0.7),
//                         ),
//                       ),
//                     ],
//                   ),
...
//                           style: const TextStyle(fontFamily : "GlacialIndifference", letterSpacing: 0.5, color: Color(0Xff696A75)))
//                     ],
//                   ),
//                 ],
//               )),
...
//         const Text(
//           '|',
//           style: TextStyle(fontFamily : "GlacialIndifference",color: Color(0xffCAD1D8)),
//         ),
//         SizedBox(
//           height: 35,
//           width: MediaQuery.of(context).size.width / 2.1,
...
//                     Text(
//                       productModel.name,
//                       style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 16, letterSpacing: 0.5, color: Color(0XFF2A2A2A)),
...
//                                 style: TextStyle(fontFamily : "GlacialIndifference",fontSize: 18,  letterSpacing: 0.5, color: Color(0xFFFEDF00)),
//                               )
//                             : Column(
//                                 crossAxisAlignment: CrossAxisAlignment.start,
//                                 children: [
...
//                         //                       }
//                         //                     },
//                         //                     icon: Icon(Icons.add, size: 18, color: Color(0xFFFEDF00)),
//                         //                     label: Text(
//                         //                       'ADD'.tr(),
//                         //                       style: TextStyle(fontFamily : "GlacialIndifference",height: 1.2, letterSpacing: 0.5, color: Color(0xFFFEDF00)),
//                         //                     ),
//                         //                     style: TextButton.styleFrom(
...
//                       child: Text(
//                         'Store Timing'.tr(),
//                         style: TextStyle(fontFamily : "GlacialIndifference",fontSize: 18,  color: isDarkMode(context) ? const Color(0XFFdadada) : const Color(0XFF252525)),
//                       )),
//                 ])),
//                 const SizedBox(
//                   height: 10,
...
//                                                   width: 5,
//                                                 ),
//                                                 Text("Closed".tr(), style: const TextStyle(fontFamily : "GlacialIndifference",  color: Colors.redAccent))
//                                               ])),
//                                         ),
//                                       )
//                                     ],
...
//                 mainAxisAlignment: MainAxisAlignment.spaceEvenly,
//                 children: [
//                   Text("From ".tr(), style: TextStyle(fontFamily : "GlacialIndifference", color: isDarkMode(context) ? const Color(0XFFa5a292) : const Color(0xff5A5D6D))),
//                   //  SizedBox(height: 5,),
//                   Text(timeslot.from.toString(),
//                       style: TextStyle(fontFamily : "GlacialIndifference", color: isDarkMode(context) ? const Color(0XFFa5a292) : const Color(0XFF5A5D6D)))
//                 ],
//               )),
//         ),
//         const SizedBox(
...
//                 mainAxisAlignment: MainAxisAlignment.spaceEvenly,
//                 children: [
//                   Text("To ".tr(), style: TextStyle(fontFamily : "GlacialIndifference", color: isDarkMode(context) ? const Color(0XFFa5a292) : const Color(0xff5A5D6D))),
//                   //  SizedBox(height: 5,),
...
//               width: 10,
//             ),
//             Text("Open".tr(), style: const TextStyle(fontFamily : "GlacialIndifference",  fontSize: 16, color: Color(0XFF3dae7d)))
//           ]));
//     } else {
//       return Container(
//           height: 35,
...
//               width: 10,
//             ),
//             Text("Close".tr(), style: const TextStyle(fontFamily : "GlacialIndifference",  fontSize: 16, letterSpacing: 0.5, color: Colors.redAccent))
//           ]));
//     }
//   }
//
...
//                   style: const TextStyle(fontFamily : "GlacialIndifference",color: Colors.white, fontWeight: FontWeight.w500, letterSpacing: 0.9),
//                 ),
//               )),
//           GestureDetector(
//             onTap: () {
...
//               child: Text(
//                 "COPY CODE".tr(),
//                 style: TextStyle(fontFamily : "GlacialIndifference",color: Color(0xFFFEDF00), fontWeight: FontWeight.w500, letterSpacing: 0.1),
//               ),
//             ),
//           ),
//           Container(
...
//               text: TextSpan(
//                 text: "Use code ".tr(),
//                 style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 16.0, color: Colors.grey, fontWeight: FontWeight.w700),
//                 children: <TextSpan>[
//                   TextSpan(
