...
import 'package:nocconsumer/ui/vendorProductsScreen/widgets/ficon_button.dart';
import 'package:nocconsumer/ui/vendorProductsScreen/widgets/helper.dart';
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          //"${offerList[index].discountTypeOffer == "Fix Price" ? currencyData!.symbol : ""}${offerList[index].discountOffer}${offerList[index].discountTypeOffer == "Percentage" ? "% OFF" : " OFF"}",
                          offerList[index].discountTypeOffer == "Fix Price" ? (currencyData!.symbolatright == true) ? "${offerList[index].discountOffer}${currencyData!.symbol.toString()} OFF":"${currencyData!.symbol.toString()}${offerList[index].discountOffer} OFF"
      ...
      if (isOpen == true) {
        return Container(
            ...
            child: Row(children: [
              ...
              Text("Open".tr(),
                  style:
                      const TextStyle(fontFamily : "GlacialIndifference",fontSize: 16, color: Color(0XFF3dae7d)))
            ]));
      } else {
        return Container(
            height: 35,
