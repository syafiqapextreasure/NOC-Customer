                ...
                child: Container(
                    ...
                    child: Padding(
                        ...
                        child: SingleChildScrollView(
                          ...
                          Text(
                            "Services".tr(),
                            style: TextStyle(fontFamily : "GlacialIndifference",fontSize: 18, color: isDarkMode(context) ? const Color(0xffFFFFFF) : const Color(0XFF000000)),
                          ),
                          Container(
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              width: 123,
                                              child:
                                              Text(vendormodel.filters.keys.elementAt(index), textAlign: TextAlign.center, style: const TextStyle(fontFamily : "GlacialIndifference",color: Color(0XFF333333))).tr(),
                                            ),
                                          ],
                                        ),
                                      ));
