...
import 'package:nocconsumer/ui/vendorProductsScreen/widgets/fappbar.dart';
    ...
    return Padding(
      ...
      child: Padding(
        ...
        child: Text(
          ...
          style: TextStyle(fontFamily : "GlacialIndifference",color: isDarkMode(context) ? Colors.white : Colors.black, fontSize: 18, fontWeight: FontWeight.w600),
        ),
      ),
    );
  }
        ...
        child: Row(children: [
          ...
          Expanded(
            ...
            children: <Widget>[
              Text(
                productModel.name,
                style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 16, letterSpacing: 0.5),
              ...
              Row(
                children: <Widget>[
                  productModel.disPrice == "" || productModel.disPrice == "0"
                    ...
                    style: TextStyle(fontFamily : "GlacialIndifference",fontSize: 16, letterSpacing: 0.5, color: Color(0xFFFEDF00)),
                        )
                      : Row(
                          children: [
                            Text(
