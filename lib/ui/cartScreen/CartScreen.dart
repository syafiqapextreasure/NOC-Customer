...
import 'package:nocconsumer/ui/deliveryAddressScreen/DeliveryAddressScreen.dart';
      ...
      if (widget.fromStoreSelection &&
        ...
        if (MyAppState.currentUser != null &&
          ...
          num km = num.parse(getKm(
              ...
              Position.fromMap(
                  {'latitude': vendorModel!.latitude, 'longitude': vendorModel!.longitude, 'timestamp': DateTime.now().microsecondsSinceEpoch})));
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(fontFamily : "GlacialIndifference",fontSize: 20, color: Color(0xFFFEDF00)),
                      ),
                    ],
                  ),
                ),
                        ...
                        if (productModel!.itemAttributes != null) {
                          if (productModel!.itemAttributes!.variants!
                            ...
                            if (int.parse(productModel!.itemAttributes!.variants!
                                        .where((element) =>
                                            element.variant_sku == variantInfo!.variant_sku)
                                        .first
                                        .variant_quantity
                                        .toString()) >
                                    quen ||
            ...
            if (element.timeslot!.isNotEmpty) {
              element.timeslot!.forEach((element) {
                if (element.discount_type == "delivery") {
                  var start =
                      DateFormat("dd-MM-yyyy HH:mm").parse(date + " " + element.from.toString());
                  var end =
                      DateFormat("dd-MM-yyyy HH:mm").parse(date + " " + element.to.toString());
    ...
    if (taxList != null) {
      for (var element in taxList!) {
        grandtotal = grandtotal +
            getTaxValue(
                amount: (subTotal - discountVal - specialDiscountAmount).toString(),
                taxModel: element);
      }
    }
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text("Add coupon code".tr(), style: const TextStyle(fontFamily : "GlacialIndifference",)),
                      ],
                    ),
                  )
                ]),
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text("remarks-restaurant".tr(), style: const TextStyle(fontFamily : "GlacialIndifference",)),
                  ],
                ),
                GestureDetector(
                  onTap: () {
                  ...
                  GestureDetector(
                    onTap: () {
                      BottomPicker.dateTime(
                        titleStyle: const TextStyle(fontFamily : "GlacialIndifference",fontWeight: FontWeight.bold, fontSize: 15),
                        onSubmit: (index) {
                          setState(() {
                        ...
                        buttonSingleColor: Color(0xFFFEDF00),
                        buttonTextStyle: const TextStyle(fontFamily : "GlacialIndifference",color: Colors.white),
                      ).show(context);
                    },
                    child: Text(
                      scheduleTime == null
                          ? "Select".tr()
                          : DateFormat("EEE dd MMMM , HH:mm aa").format(scheduleTime!.toDate()),
              ...
              Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        "Delivery Option: ".tr(),
                        style: TextStyle(fontFamily : "GlacialIndifference",fontSize: _font),
                      ),
                      Text(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style:
                            TextStyle(fontFamily : "GlacialIndifference",  color: Colors.red, fontSize: _font),
                      ),
                    ],
                  )),
              const Divider(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: TextStyle(fontFamily : "GlacialIndifference",
                                    color: Colors.red, fontSize: _font),
                            ),
                          ],
                        )),
                    const Divider(
            ...
            ? Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "tip-to-driver".tr(),
                      style: const TextStyle(fontFamily : "GlacialIndifference",color: Color(0xff9091A4), fontSize: 14),
                    ),
                    const SizedBox(
                      height: 15,
                    ),
                      ...
                      children: [
                        ...
                        Container(
                            ...
                            child: Text(
                              ...
                              style: const TextStyle(fontFamily : "GlacialIndifference",color: Color(0XFF2A2A2A), fontSize: 16),
                            )),
                        Container(
                                    ...
                                    child: Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                            ...
                                            hintStyle: const TextStyle(fontFamily : "GlacialIndifference",color: Color(0XFF9091A4)),
                                            labelStyle: const TextStyle(fontFamily : "GlacialIndifference",color: Color(0XFF333333)),
                        ...
                        Padding(
                          ...
                          child: ElevatedButton(
                            ...
                            // onPressed: () {
                            //   print("OFFER CODE >>>>>>>>>>>   " + txt.text.toString());
                            //   percentage = 0.0;
                            //   type = 0.0;
                            //   couponId = "";
                            //   setState(() {
          ...
          return AlertDialog(
            ...
            actions: <Widget>[
              ElevatedButton(
                style: ElevatedButton.styleFrom(
                    backgroundColor: Color(0xFFFEDF00),
                    textStyle: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 15, fontWeight: FontWeight.normal)),
