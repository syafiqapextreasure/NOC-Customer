...
import 'package:nocconsumer/ui/orderDetailsScreen/order_tracking_screen.dart';
import 'package:nocconsumer/ui/reviewScreen.dart/reviewScreen.dart';
...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
                                      ...
                                      Padding(
                                        ...
                                        child: RichText(
                                          text: TextSpan(children: [
                                            ...
                                            TextSpan(
                                              text: orderStatus == ORDER_STATUS_IN_TRANSIT ? ": $duration" : "",
                                              style: TextStyle(fontFamily : "GlacialIndifference",
                                                letterSpacing: 0.5,
                                                color: isDarkMode(context)
                                                    ? Colors.grey.shade200
  ...
  driverEstimatedTime() async {
    double originLat, originLong, destLat, destLong;
    originLat = _driverModel!.location.latitude;
    originLong = _driverModel!.location.longitude;
                  ...
                  child: InkWell(
                    child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            border: Border.all(
                                width: 0.8, color: Color(0xFFFEDF00))),
                        child: Center(
                          child: Text(
