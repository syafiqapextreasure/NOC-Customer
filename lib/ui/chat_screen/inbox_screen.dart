            ...
            child: ListTile(
              ...
              title: Row(
                children: [
                  ...
                  Text(DateFormat('MMM d, yyyy').format(DateTime.fromMillisecondsSinceEpoch(inboxModel.createdAt!.millisecondsSinceEpoch)), style: TextStyle(fontFamily : "GlacialIndifference",color: Colors.grey, fontSize: 14)),
                ],
              ),
