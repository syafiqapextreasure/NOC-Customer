  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text(
            "QR Code Scanner".tr(),
            style: TextStyle(fontFamily : "GlacialIndifference",letterSpacing: 0.5, fontWeight: FontWeight.normal, color: isDarkMode(context) ? Colors.white : Colors.black),
          ),
          centerTitle: false,
                    ...
                    child: SizedBox(
                      ...
                      child: QRBarScannerCamera(
                        onError: (context, error) => Text(
                          error.toString(),
                          style: const TextStyle(fontFamily : "GlacialIndifference",color: Colors.red),
                        ),
                        qrCodeCallback: (code) {
                          // _qrCallback(code);
