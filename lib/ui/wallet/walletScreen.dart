...
import 'package:nocconsumer/cab_service/cab_order_detail_screen.dart';
import 'package:nocconsumer/model/CabOrderModel.dart';
import 'package:nocconsumer/model/FlutterWaveSettingDataModel.dart';
import 'package:nocconsumer/model/MercadoPagoSettingsModel.dart';
import 'package:nocconsumer/model/PayFastSettingData.dart';
import 'package:nocconsumer/model/PayPalCurrencyCodeErrorModel.dart'
    as payPalCurrModel;
import 'package:nocconsumer/model/PayStackSettingsModel.dart';
import 'package:nocconsumer/model/StripePayFailedModel.dart';
import 'package:nocconsumer/model/createRazorPayOrderModel.dart';
import 'package:nocconsumer/model/payStackURLModel.dart';
import 'package:nocconsumer/model/paypalClientToken.dart';
import 'package:nocconsumer/model/paypalErrorSettle.dart';
import 'package:nocconsumer/model/paypalPaymentSettle.dart' as payPalSettel;
...
import 'package:nocconsumer/parcel_delivery/parcel_ui/parcel_order_detail_screen.dart';
import 'package:nocconsumer/rental_service/model/rental_order_model.dart';
import 'package:nocconsumer/rental_service/renatal_summary_screen.dart';
import 'package:nocconsumer/services/FirebaseHelper.dart';
import 'package:nocconsumer/services/paypalclientToken.dart';
import 'package:nocconsumer/services/paystack_url_genrater.dart';
import 'package:nocconsumer/services/rozorpayConroller.dart';
import 'package:nocconsumer/services/show_toast_dialog.dart';
import 'package:nocconsumer/ui/wallet/MercadoPagoScreen.dart';
import 'package:nocconsumer/ui/wallet/PayFastScreen.dart';
import 'package:nocconsumer/ui/wallet/payStackScreen.dart';
...
class WalletScreenState extends State<WalletScreen> {
  ...
  void initPayPal() async {
    ...
    await _flutterPaypalNativePlugin.init(
      ...
      returnUrl: "com.noc.app://paypalpay",
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ClipOval(
                  child: Container(
                    color: Color(0xFFFEDF00).withOpacity(0.06),
                    child: Padding(
                      child: Icon(Icons.account_balance_wallet_rounded,
                          size: 28, color: Color(0xFFFEDF00)),
                            ...
                            child: Row(
                              ...
                              children: [
                                ClipOval(
                                  child: Container(
                                    color:
                                        Color(0xFFFEDF00).withOpacity(0.05),
                                    child: Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: Icon(
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      if (!topupTranHistory.isTopup) {
                                        if (topupTranHistory.serviceType ==
                                            "cab-service") {
                                    ...
                                    child: Text(
                                      topupTranHistory.isTopup
                                          ? topupTranHistory.payment_method
                                              .toUpperCase()
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Visibility(
                          visible: payFastSettingData?.isEnable?? false,
                          child: Padding(
                            padding: const EdgeInsets.symmetric(
                        ...
                        Visibility(
                          visible: mercadoPagoSettingData?.isEnabled??false,
                          child: Padding(
                            padding: const EdgeInsets.symmetric(
                                vertical: 4.0, horizontal: 20),
                            child: Card(
                        ...
                        Visibility(
                          visible: paypalSettingData?.isEnabled?? false,
                          child: Padding(
                            padding: const EdgeInsets.symmetric(
                                vertical: 3.0, horizontal: 20),
                            child: Card(
  ...
  _flutterWaveInitiatePayment(
    ...
    final style = FlutterwaveStyle(
      appBarText: "NOC",
      buttonColor: Color(0xFFFEDF00),
      buttonTextStyle: const TextStyle(fontFamily : "GlacialIndifference",
        color: Colors.white,
        fontSize: 20,
      ),
      appBarColor: Color(0xFFFEDF00),
      dialogCancelTextStyle: const TextStyle(fontFamily : "GlacialIndifference",
        color: Colors.black,
        fontSize: 18,
      ),
      ...
      mainTextStyle:
          const TextStyle(fontFamily : "GlacialIndifference",color: Colors.black, fontSize: 19, letterSpacing: 2),
      dialogBackgroundColor: Colors.white,
      appBarTitleTextStyle: const TextStyle(fontFamily : "GlacialIndifference",
        color: Colors.white,
        fontSize: 18,
      ),
    );
