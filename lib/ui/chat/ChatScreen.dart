...
// import 'package:nocconsumer/model/ChatModel.dart';
// import 'package:nocconsumer/model/ChatVideoContainer.dart';
// import 'package:nocconsumer/model/ConversationModel.dart';
// import 'package:nocconsumer/model/HomeConversationModel.dart';
// import 'package:nocconsumer/model/MessageData.dart';
...
// import 'package:nocconsumer/ui/chat/PlayerWidget.dart';
// import 'package:nocconsumer/ui/fullScreenImageViewer/FullScreenImageViewer.dart';
// import 'package:nocconsumer/ui/fullScreenVideoViewer/FullScreenVideoViewer.dart';
...
//               style: TextStyle(fontFamily : "GlacialIndifference",color: isDarkMode(context) ? Colors.grey.shade200 : Colors.white, fontWeight: FontWeight.bold),
//             ),
//             Padding(
...
//                                     child: Icon(
//                                       Icons.mic,
//                                       color: currentRecordingState == RecordingState.HIDDEN ? Color(0xFFFEDF00) : Colors.red,
//                                     ),
//                                   ),
//                                   Expanded(
//                                     child: TextField(
...
//                                         hintStyle: TextStyle(fontFamily : "GlacialIndifference",color: Colors.grey.shade400),
...
//                         icon: Icon(
//                           Icons.send,
//                           color: _messageController.text.isEmpty ? Color(0xFFFEDF00).withOpacity(.5) : Color(0xFFFEDF00),
//                         ),
//                         onPressed: () async {
...
//                             child: Text(
//                               'Send'.tr(),
//                               style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),
//                             ).tr(),
...
//                             child: Text(
//                               'Cancel'.tr(),
//                               style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 20, color: Colors.white, fontWeight: FontWeight.bold),
//                             ).tr(),
...
//     return Text(text, style: TextStyle(fontFamily : "GlacialIndifference",fontSize: 15, color: Colors.grey.shade200));
//   }
//
//   _onCameraClick() {
...
//       message: Text(
//         'Send media'.tr(),
//         style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 15.0),
//       ).tr(),
//       actions: <Widget>[
...
//                     style: TextStyle(fontFamily : "GlacialIndifference",color: isDarkMode(context) ? Colors.white : Colors.black, fontSize: 16),
//                   ),
//                 ),
//               ]),
//             ),
...
//                     child: PlayerWidget(
//                       url: messageData.url.url,
//                       color: isDarkMode(context) ? const Color(COLOR_ACCENT) : Color(0xFFFEDF00),
//                     ),
//                   ),
//                 ]),
//               ),
