...
import 'package:nocconsumer/ui/resetPasswordScreen/ResetPasswordScreen.dart';
...
class _LoginScreen extends State<LoginScreen> {
        ...
        child: ListView(
          children: <Widget>[
            Padding(
              ...
              child: Text(
                'signIn'.tr(),
                style: TextStyle(fontFamily : "GlacialIndifference",color: Color(0xFFFEDF00), fontSize: 25.0, fontWeight: FontWeight.bold),
              ).tr(),
            ),
            ...
            ConstrainedBox(
              ...
              child: Padding(
                ...
                child: TextFormField(
                    ...
                    style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 18.0),
                    keyboardType: TextInputType.emailAddress,
                    cursorColor: Color(0xFFFEDF00),
                    decoration: InputDecoration(
                      contentPadding: const EdgeInsets.only(left: 16, right: 16),
                      hintText: 'emailAddress'.tr(),
                      focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(25.0), borderSide: BorderSide(color: Color(0xFFFEDF00), width: 2.0)),
            ...
            Padding(
              ...
              child: Align(
                ...
                child: GestureDetector(
                  ...
                  child: Text(
                    'Forgot password?'.tr(),
                    style: const TextStyle(fontFamily : "GlacialIndifference",color: Colors.lightBlue, fontWeight: FontWeight.bold, fontSize: 15, letterSpacing: 1),
                  ),
                ),
              ),
            ),
            ...
            Padding(
              ...
              child: Center(
                child: Text(
                  'or'.tr(),
                  style: TextStyle(fontFamily : "GlacialIndifference",color: isDarkMode(context) ? Colors.white : Colors.black),
                ).tr(),
              ),
            ),
                ...
                child: ElevatedButton.icon(
                    label: Container(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(fontFamily : "GlacialIndifference",fontSize: 20, fontWeight: FontWeight.bold, color: Colors.grey.shade200),
                        ).tr()),
                    icon: Padding(
            ...
            InkWell(
              ...
              child: Padding(
                ...
                child: Container(
                    ...
                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(25), border: Border.all(color: Color(0xFFFEDF00), width: 1)),
                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(fontFamily : "GlacialIndifference",
                            color: Colors.black, fontWeight: FontWeight.bold, fontSize: 17, letterSpacing: 1),
                      ),
                    ])),
              ),
            )
  ...
  _loginWithEmailAndPassword(String email, String password) async {
    ...
    if (result != null && result is User && result.role == USER_ROLE_CUSTOMER) {
      ...
      showAlertDialog(context, 'Couldn\'t Authenticate'.tr(), "Login Credentials is wrong.please insert to correct credentials.", true);
    } else {
