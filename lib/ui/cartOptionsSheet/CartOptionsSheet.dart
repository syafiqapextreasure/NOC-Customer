      ...
      child: Column(
        ...
        children: [
          ...
          Center(
            ...
            style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 20, fontWeight: FontWeight.bold),
          )),
          const SizedBox(height: 24),
          Center(
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    '$quantity',
                    style: const TextStyle(fontFamily : "GlacialIndifference",fontWeight: FontWeight.bold),
                  ),
                  IconButton(
          ...
          Padding(
            ...
            child: ElevatedButton(
              ...
              child: Text(
                'Update Cart'.tr(),
                style: TextStyle(fontFamily : "GlacialIndifference",color: isDarkMode(context) ? Colors.white : Colors.black, fontWeight: FontWeight.bold, fontSize: 20),
              ),
              onPressed: () {
          ...
          Padding(
            ...
            child: CupertinoButton(
                child: Text(
                  'Remove from Cart'.tr(),
                  style: const TextStyle(fontFamily : "GlacialIndifference",color: Colors.red, fontWeight: FontWeight.bold),
                ),
                onPressed: () {
