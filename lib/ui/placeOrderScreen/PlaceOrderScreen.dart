      ...
      child: Column(
        children: [
          ListTile(
            title: Text(
              'Placing Order...'.tr(),
              style: TextStyle(fontFamily : "GlacialIndifference",color: isDarkMode(context) ? Colors.grey.shade300 : Colors.grey.shade800, fontSize: 20, fontWeight: FontWeight.bold),
            ),
            trailing: SizedBox(
              width: 24,
              height: 24,
              ...
              children: [
                ListTile(
                  ...
                  title: Text(
                    ...
                    style: TextStyle(fontFamily : "GlacialIndifference",color: isDarkMode(context) ? Colors.grey.shade300 : Colors.grey.shade800, fontWeight: FontWeight.w500, fontSize: 17),
                  ),
