...
showProgress(BuildContext context, String message, bool isDismissible) async {
  ...
  pd!.style(
      ...
      messageTextStyle: const TextStyle(fontFamily : "GlacialIndifference",color: Colors.black, fontSize: 19.0, fontWeight: FontWeight.w600));
  await pd!.show();
}
...
Widget showEmptyState(String title, BuildContext context, {String? description, String? buttonTitle, VoidCallback? action}) {
  return Center(
    child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, children: [
      ...
      Text(title, style: TextStyle(fontFamily : "GlacialIndifference",fontSize: 20, fontWeight: FontWeight.w600, color: isDarkMode(context) ? Colors.white : Colors.black)),
        ...
        Padding(
          ...
          child: ConstrainedBox(
            ...
            child: ElevatedButton(
                child: Text(
                  buttonTitle!,
                  style: TextStyle(fontFamily : "GlacialIndifference",color: isDarkMode(context) ? Colors.white : Colors.black, fontSize: 18),
                ),
        ...
        actions: [
          if (action != null)
            TextButton(
              child: Text(
                secondaryButtonText!,
                style: const TextStyle(fontFamily : "GlacialIndifference",color: Colors.redAccent),
              ),
              onPressed: action,
            ),
          TextButton(
