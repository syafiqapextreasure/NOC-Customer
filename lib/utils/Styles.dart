...
class Styles {
  static ThemeData themeData(bool isDarkTheme, BuildContext context) {
    return ThemeData(
      primaryColor: isDarkTheme ? const Color(0xff131218) : Color(0xFFFEDF00),
      ...
      appBarTheme: isDarkTheme
          ...
          : AppBarTheme(titleTextStyle: TextStyle(fontFamily : "GlacialIndifference",color: Color(0xFFFEDF00)), backgroundColor: Colors.white, centerTitle: true, iconTheme: IconThemeData(color: Colors.black), elevation: 0),
      textSelectionTheme: TextSelectionThemeData(selectionColor: isDarkTheme ? Colors.yellow : Colors.black),
    );
  }
}
