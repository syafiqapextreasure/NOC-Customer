...
import 'package:nocconsumer/widget/my_separator.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(ratingModel != null ? "Update Reviews".tr() : "Add Review".tr(), style: const TextStyle(fontFamily : "GlacialIndifference",color: Colors.black)).tr(),
      ),
      body: Form(
          key: _formKey,
                            ...
                            child: Column(
                              children: [
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Text("${widget.order.driver!.firstName} ${widget.order.driver!.lastName}",
                                          style: const TextStyle(fontFamily : "GlacialIndifference",color: Colors.black87, fontWeight: FontWeight.w600, fontSize: 18)),
                                    ),
                                    Padding(
                                ...
                                Row(
                                  ...
                                  crossAxisAlignment: CrossAxisAlignment.center,
                                  children: [
                                    Text(driverUser!.carNumber.toUpperCase().toString(), style: const TextStyle(fontFamily : "GlacialIndifference",color: Colors.black87, fontWeight: FontWeight.w600)),
                                    Padding(
                                      padding: const EdgeInsets.only(left: 8.0),
                                      child: Text("${driverUser!.carName} ${driverUser!.carMakes}", style: const TextStyle(fontFamily : "GlacialIndifference",color: Colors.black38, fontWeight: FontWeight.w600)),
                                    ),
                                  ],
                                ),
                                const Padding(
                                 ...
                                 Padding(
                                  ...
                                  child: Text(
                                    'How is your trip?'.tr(),
                                    style: TextStyle(fontFamily : "GlacialIndifference",fontSize: 18, color: Colors.black, fontWeight: FontWeight.bold, letterSpacing: 2),
                                  ),
                                ),
                                Padding(
                                  ...
                                  child: Text(
                                    ...
                                    style: TextStyle(fontFamily : "GlacialIndifference",color: Colors.black.withOpacity(0.60), letterSpacing: 0.8),
                                  ),
                                ),
                                Padding(
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    ...
                                    style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 18, color: Colors.black, fontWeight: FontWeight.bold, letterSpacing: 2),
                                  ),
                                ),
                                Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                          ...
                                          focusedBorder: OutlineInputBorder(
                                            borderSide: BorderSide(color: Color(0xFFFEDF00), width: 0.7),
                                          ),
                                          ...
                                          hintStyle: TextStyle(fontFamily : "GlacialIndifference",color: Colors.black.withOpacity(0.60))),
                                      maxLines: 5,
                                    )),
                                Padding(
                                  ...
                                  child: MaterialButton(
                                    ...
                                    child: Text(
                                      ...
                                      style: TextStyle(fontFamily : "GlacialIndifference",color:  Colors.black, fontSize: 16),
                                    ),
                                  ),
                                ),
                              ],
          ...
          //                     child: Text(
        //                       "Rate For Driver".tr(),
          //                       style: const TextStyle(fontFamily : "GlacialIndifference",color: Color(0XFF7C848E), fontSize: 17),
          //                     )),
          //                 const SizedBox(
          //                   height: 15,
          //                 ),
          ...
          //                         decoration: InputDecoration(
        //                             hintText: 'Type comment....'.tr(),
          //                             hintStyle: const TextStyle(fontFamily : "GlacialIndifference",color: const Color(0XFF8A8989)),
  ...
  savereview() async {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      if (ratingModel != null) {
        ...
        await FireStoreUtils.firebaseCreateNewReview(rate).then((value) async {
          await hideProgress();
          Navigator.pop(context);
        });
        await FireStoreUtils.updateCurrentUser(user!);
