      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
                    ...
                    if (snapshot.data?.isNotEmpty ?? false) {
                      ...
                      snapshot.data!.forEach((element) {
                        if (element.rentalBookingDate!.isNotEmpty) {
                          print(element.rentalBookingDate!.first.runtimeType);
                          print(widget.rentalOrderModel!.pickupDateTime!
                              .toDate());
                          print(
                              widget.rentalOrderModel!.dropDateTime!.toDate());
                          print(element.rentalBookingDate!.first.toDate());
                          print(element.rentalBookingDate!.last.toDate());
                          print(widget.rentalOrderModel!.pickupDateTime!
                              .toDate()
                              .isAfter(
                                  element.rentalBookingDate!.first.toDate()));
                          print(widget.rentalOrderModel!.pickupDateTime!
                              .toDate()
                              .isBefore(
                                  element.rentalBookingDate!.last.toDate()));
                          print(widget.rentalOrderModel!.pickupDateTime!
                                  .toDate()
            ...
            //                         Text(
            //                           "${driverList[index].carName.toString()} ${driverList[index].carMakes.toString()}",
            //                           style: const TextStyle(fontFamily : "GlacialIndifference",color: Colors.black, fontSize: 16, letterSpacing: 2, fontWeight: FontWeight.w600),
            //                         ),
            //                         const SizedBox(
            //                           height: 5,
            //                         ),
            ...
            //                                     style: TextStyle(fontFamily : "GlacialIndifference",color: Colors.black.withOpacity(0.50), letterSpacing: 2, fontWeight: FontWeight.w600),
            //                                   ),
            //                                   const SizedBox(
            //                                     width: 10,
            //                                   ),
            ...
            //                               style: TextStyle(fontFamily : "GlacialIndifference",color: Color(0xFFFEDF00), letterSpacing: 0.5, fontWeight: FontWeight.w900),
            //                             ),
            //                             Text(
            //                               "/day",
            //                               style: TextStyle(fontFamily : "GlacialIndifference",color: Colors.black.withOpacity(0.50), letterSpacing: 0.5, fontWeight: FontWeight.w600),
            //                             ),
            //                           ],
            //                         )
            //                       ],
