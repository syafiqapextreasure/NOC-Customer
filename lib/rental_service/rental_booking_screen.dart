  ...
  buildRideType({required String label, required index}) {
    ...
    return Padding(
      ...
      child: ChoiceChip(
        ...
        labelStyle: TextStyle(fontFamily : "GlacialIndifference",fontSize: 16, color: textColor),
        label: Text(
          label,
        ),
                              ...
                              child: Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    child: const Text(
                                      'Add Review',
                                      style: TextStyle( color: Colors.black,fontFamily : "GlacialIndifference",fontSize: 16),
                                    ).tr(),
                                  ),
                                ),
                              ),
                                  ...
                                  await FireStoreUtils.updateRentalOrder(
                                    ...
                                    if (orderModel.paymentMethod
                                      ...
                                      */
                                      ...
                                      FireStoreUtils.createPaymentId()
                                          .then((value) {
