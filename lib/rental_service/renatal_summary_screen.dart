            ...
            child: Row(
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(fontFamily : "GlacialIndifference",color: Colors.black.withOpacity(0.50)),
                ),
                Text(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(fontFamily : "GlacialIndifference",color: Color(0xFFFEDF00), fontSize: 16),
                ),
              ],
            )),
      ],
          ...
          Expanded(
            child: Column(
              ...
              children: [
                const Text(
                  "Driver by",
                  style: TextStyle(fontFamily : "GlacialIndifference",color: Colors.black38),
                ).tr(),
                const SizedBox(
                  height: 4,
                ),
                Text(
                  ...
                  style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 17, color: Colors.black),
                ),
              ],
            ),
          ),
        ...
        child: Column(
          ...
          children: [
            Text(
              ...
              style: const TextStyle(fontFamily : "GlacialIndifference",fontSize: 18, color: Colors.black),
            ),
            const SizedBox(
              height: 5,
            ),
