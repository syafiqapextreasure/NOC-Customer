...
import 'package:nocconsumer/rental_service/rental_booking_screen.dart';
import 'package:nocconsumer/rental_service/rental_service_dash_board.dart';
                    ...
                    Row(
                      ...
                      children: [
                        Icon(Icons.access_time_rounded,
                            color: Color(0xFFFEDF00), size: 18),
                        const SizedBox(
                          width: 5,
                        ),
                        Expanded(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(fontFamily : "GlacialIndifference",color: Colors.red, fontSize: 16),
                  ),
                ],
              )),
          const Divider(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(fontFamily : "GlacialIndifference",color: isDarkMode(context) ? const Color(0xffFFFFFF) : const Color(0xff333333), fontSize: 16),
                  ),
                ],
              )),*/
          // const Divider(
                                    ...
                                    child: Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                            ...
                                            hintStyle: const TextStyle(fontFamily : "GlacialIndifference",
                                                color: Color(0XFF9091A4)),
                                            labelStyle: const TextStyle(fontFamily : "GlacialIndifference",
